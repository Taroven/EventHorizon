...
config.width = 150						-- Width of a single bar, not counting its icon. The actual width of the frame is (width+height+[padding*2]).
...
config.past = -3						-- Number of seconds to show in the past. Default = -3 (yes, it's a negative number)
